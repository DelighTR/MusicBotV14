...
{
name: "create",
description: "Bir oynatma listesi oluşturun.",
...
{
name: "public",
description: "Oynatma listesini herkese açık yapın. (true=genel oynatma listesi, false=özel oynatma listesi)",
...
{
name: "delete",
description: "Bir oynatma listesini silin.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
description: "Silmek istediğiniz oynatma listesinin adını yazın.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "add-music",
description: "Çalma listesine müzik eklemenizi sağlar.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "playlist-name",
description: "Bir oynatma listesi adı yazın.",
type: ApplicationCommandOptionType.String,
required: true
},
{
name: "name",
description: "Bir müzik adı veya müzik bağlantısı yazın.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "delete-music",
description: "Müziği çalma listesine silmenizi sağlar.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "playlist-name",
...
{
name: "name",
description: "Bir müzik adı yazın.",
type: ApplicationCommandOptionType.String,
required: true
}
]
...
{
name: "list",
description: "Bir çalma listesindeki müziğe göz atın.",
type: ApplicationCommandOptionType.Subcommand,
options: [
{
name: "name",
...
{
name: "lists",
description: "Tüm oynatma listelerinize göz atın.",
type: ApplicationCommandOptionType.Subcommand,
options: []
},
{
name: "top",
description: "En popüler çalma listelerine göz at.",
type: ApplicationCommandOptionType.Subcommand,
options: []
}
