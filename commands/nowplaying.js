...
> URL: **${track.url}**
> Tekrar Modu \`${queue.repeatMode ? (queue.repeatMode === 2 ? 'All Queue' : 'This Song') : 'Off'}\`
> Filtreler: \`${queue.filters.names.join(', ') || 'Off'}\`
> Yayınlayan: <@${track.user.id}>`);

      embed.setTimestamp();
      embed.setFooter({ text: `Delight ❤️` })
